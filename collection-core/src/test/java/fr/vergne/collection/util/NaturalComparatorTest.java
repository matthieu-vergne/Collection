...
public class NaturalComparatorTest {
	...
	public void testReallyBigNumbers() {
		NaturalComparator comparator = new NaturalComparator();
		assertTrue(comparator.compare("abc123456789123456789123456788def", "abc123456789123456789123456789def") < 0);
		assertTrue(comparator.compare("abc123456789123456789123456789def", "abc123456789123456789123456788def") > 0);
	}

	@Test
	public void testReallySmallNumbers() {
		NaturalComparator comparator = new NaturalComparator();
		assertTrue(comparator.compare("abc0.0000000000000000000000001def", "abc0.0000000000000000000000002def") < 0);
		assertTrue(comparator.compare("abc0.0000000000000000000000002def", "abc0.0000000000000000000000001def") > 0);
	}
